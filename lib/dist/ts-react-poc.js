(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["TSReactPOC"] = factory(require("react"));
	else
		root["TSReactPOC"] = factory(root["React"]);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "Hello", function() { return /* reexport */ src_Hello; });
__webpack_require__.d(__webpack_exports__, "Goodbye", function() { return /* reexport */ src_Goodbye; });
...
var Emotion = /* #__PURE__ */core_browser_esm_withEmotionCache(function (props, cache, ref) {
  ...
  if (typeof props.css === 'function') {
    return Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"])(ThemeContext.Consumer, null, function (theme) {
...
// CONCATENATED MODULE: ./src/Hello.tsx
...
function Hello(props) {
  ...
  return core_browser_esm_jsx("div", {
    ...
    /*#__PURE__*/
    css_browser_esm("padding:32px;background-color:hotpink;font-size:24px;border-radius:4px;&:hover{color:", color, ";};label:Hello;" + ( true ? "" : undefined), ";label:Hello;"),
...
/* harmony default export */ var src_Hello = (Hello);
...
function create_emotion_browser_esm_merge(registered, css, className) {
  var registeredStyles = [];
  var rawClassName = getRegisteredStyles(registered, registeredStyles, className);
...
var create_emotion_browser_esm_createEmotion = function createEmotion(options) {
  ...
  var cx = function cx() {
    ...
    return create_emotion_browser_esm_merge(cache.registered, css, create_emotion_browser_esm_classnames(args));
  };
  ...
  return {
    ...
    merge: create_emotion_browser_esm_merge.bind(null, cache.registered, css)
  };
};
...
// CONCATENATED MODULE: ./src/Goodbye.tsx



function Goodbye_EMOTION_STRINGIFIED_CSS_ERROR_() { return "You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop)."; }
...
function Goodbye(props) {
  var greeting = props.greeting;
  return core_browser_esm_jsx("div", {
    className: emotion_esm_cx("goodbye-container", Goodbye_styles.goodbyeContainer)
  }, greeting);
}
var Goodbye_styles = {
  goodbyeContainer: /*#__PURE__*/emotion_esm_css( true ? {
    name: "168mjbr-goodbyeContainer",
    styles: "width:100%;height:100%;border:1px solid magenta;;label:goodbyeContainer;"
  } : undefined)
};
/* harmony default export */ var src_Goodbye = (Goodbye);
// CONCATENATED MODULE: ./src/index.tsx
 // export type { HelloProps } from './Hello';

 // export type { GoodbyeProps } from './Goodbye';
