...
var Hello_styles = {
  helloContainer: emotion_esm_css(_templateObject())
};
/* harmony default export */ var src_Hello = (Hello);
// CONCATENATED MODULE: ./src/Goodbye.tsx
function Goodbye_templateObject() {
  var data = Goodbye_taggedTemplateLiteral(["\n    width: 100%;\n    height: 100%;\n    border: 1px solid magenta;\n  "]);

  Goodbye_templateObject = function _templateObject() {
    return data;
  };
...
function Goodbye_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var Goodbye_styles = {
  goodbyeContainer: emotion_esm_css(Goodbye_templateObject())
};
